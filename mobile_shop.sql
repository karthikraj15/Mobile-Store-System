...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2022 at 01:01 PM
...
(1, 'https://media.wired.com/photos/5e8d09b9798a15000821feb0/1:1/w_1800,h_1800,c_limit/Gear-Feature-Samsung-Galaxy-A51-front-SOURCE-Samsung.jpg', 'Samsung Galaxy M32', '20-01-2019', 30000, 1001, 22, 'active'),
(2, 'https://m.media-amazon.com/images/I/61NoYt2pvpS._SX679_.jpg', 'Nokia 5', '23-08-2019', 15000, 1002, 18, 'active'),
...
(10, 'https://m.media-amazon.com/images/I/81-tqKsrTuL._SX466_.jpg', 'Samsung Galaxy M52 5', '14-10-2020', 40000, 1001, 15, 'active');
...
--
ALTER TABLE `orders`
  MODIFY `Ord_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5025;

--
-- AUTO_INCREMENT for table `trig`
--
ALTER TABLE `trig`
  MODIFY `trig_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
